...
int main(int argc, char** argv)
{
    ...
    String window_name = "LAU"; 
    String window_name_blurred_with_3x3_kernel = "LAU Blurred with 3 x 3 Kernel";
    String window_name_blurred_with_5x5_kernel = "LAU Blurred with 5 x 5 Kernel";
